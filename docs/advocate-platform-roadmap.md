...
- Initial owner onboarding proves simultaneous claim, delivery, revocation, reissue, redemption, and archive races through the two-session harness tracked by FF-039 before production activation.
