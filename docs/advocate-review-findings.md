...
The authoritative review baseline is PR 127 at `03806587621477ef8c86b946e59431b053f5a9d5`. The latest fully validated review revision is `bb92a25`, including checkout RPC retirement and strict retention evidence. The decimal-rounding candidate `30a2370` awaits its own hosted results. Existing local checkouts were left intact; local services remain stopped.
