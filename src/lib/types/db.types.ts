    ...
    Tables: {
      activities: {
        Row: {
          ...
          created_at: string
          created_by: Database["public"]["Enums"]["activity_source"] | null
          description: string | null
          id: string
          images_url: Json | null
          title: string | null
          user_id: string | null
          videos_url: Json | null
        }
        Insert: {
          activity_type?: Database["public"]["Enums"]["activity_type"] | null
          beneficiary_id?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "people_activities_child_id_fkey"
          ...
          {
            foreignKeyName: "people_activities_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      activity_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "beneficiary_subscriptions_beneficiary_id_fkey"
            columns: ["beneficiary_id"]
            isOneToOne: false
            referencedRelation: "beneficiaries"
            referencedColumns: ["id"]
      ...
      beneficiaries: {
        Row: {
          ...
          metadata: Json | null
          name: string | null
          status: Database["public"]["Enums"]["PersonStatus"] | null
      ...
      expense_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_assignments_beneficiary_id_fkey"
            columns: ["beneficiary_id"]
            isOneToOne: false
            referencedRelation: "beneficiaries"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "expense_assignments_expense_id_fkey"
            columns: ["expense_id"]
            isOneToOne: false
      ...
      initiative: {
        ...
        Relationships: [
          {
            foreignKeyName: "initiative_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization"
            referencedColumns: ["id"]
      ...
      permission_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "permission_assignments_permission_id_fkey"
      ...
      project: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_initiative_id_fkey"
      ...
      role_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_assignments_advocate_id_fkey"
            columns: ["advocate_id"]
            isOneToOne: false
            referencedRelation: "advocate"
            referencedColumns: ["id"]
          },
          {
      ...
      transaction_ledger: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaction_ledger_child_id_fkey"
            columns: ["beneficiary_id"]
            isOneToOne: false
            referencedRelation: "beneficiaries"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "transaction_ledger_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
