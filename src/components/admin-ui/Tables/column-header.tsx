  ...
  return (
    <div className={cn("flex items-center space-x-2", className)}>
      <MenuRoot>
        ...
        <MenuContent>
          <MenuItem value="asc" onClick={() => column.toggleSorting(false)}>
            <FaArrowUp className="mr-2 h-3.5 w-3.5 text-muted-foreground/70" />
            <span>Asc</span>
          </MenuItem>
          <MenuItem value="desc" onClick={() => column.toggleSorting(true)}>
            <FaArrowDown className="mr-2 h-3.5 w-3.5 text-muted-foreground/70" />
            <span>Desc</span>
          </MenuItem>
          <MenuSeparator />
          <MenuItem value="hide" onClick={() => column.toggleVisibility(false)}>
