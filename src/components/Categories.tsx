import { CleanWaterIcon, EducationIcon, FoodSecurityIcon, HealthcareIcon, MentalHealthIcon, ShelterIcon } from '@/utils/icons'
...
const categories = [
  ...
  },
  {
    icon: HealthcareIcon,
    title: 'Healthcare',
    description: 'Provide medical care and supplies to underserved communities.'
  },
  {
    icon: CleanWaterIcon,
    title: 'Clean Water',
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-4">Core Funding categories</h2>
        <p className="text-gray-600 text-center mb-16">Lorem ipsum dolor sit amet, consectetur adipis elit</p>
