...
const FAQ_ITEMS: FAQItem[] = [
  {
    question: "How long does it take after I sponsor for a child to receive aid?",
    answer:
  ...
  {
    question: "How frequently will I receive updates from the child and their family?",
    answer:
  ...
  {
    question: "Does all of my sponsorship go directly to resources for the child I am sponsoring?",
    answer:
  ...
  },
  {
    ...
    answer: (
      <>
        We can choose one for you, or you might be better suited to our family partnership program.{" "}
        <a
          href="https://www.sharetanzania.com/partnership"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#1C3C8C] hover:underline font-medium"
        >
          www.sharetanzania.com/partnership
        </a>
      </>
    ),
  },
  {
    question: "What if I want to sponsor a special needs child who is already receiving full time care?",
    answer:
            ...
            {FAQ_ITEMS.map((item, index) => (
              ...
              >
                <Accordion.ItemTrigger className="w-full text-left px-6 py-5 bg-gray-50 hover:bg-gray-100 transition-colors flex justify-between items-start gap-4 cursor-pointer">
                  <Text fontWeight="semibold" color="gray.800" fontSize="sm" lineHeight="1.5">
                    {item.question}
                  </Text>
