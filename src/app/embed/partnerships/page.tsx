    ...
    <Flex minH="100vh" align="center" justify="center" bg="white" py={8}>
      ...
      >
        ...
        <Text color="gray.500" fontSize="sm" textAlign="center" mt={3}>
          Your {selectedOption === "subscription" ? "monthly" : "yearly"}{" "}
          contribution of ${amount} helps us continue our mission of providing
          safety, healing, and a future full of promise for vulnerable children.
        </Text>
      </Box>
    </Flex>
  )
