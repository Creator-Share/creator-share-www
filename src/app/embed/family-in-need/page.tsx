...
export default function SponsorshipEmbedFamilyPage() {
  ...
  const effectiveGoalCents =
    publicHardcodedCents !== null
      ? publicHardcodedCents
      : family?.budget_goal || 0

  const remainingAmount =
    (effectiveGoalCents - (family?.budget_raised || 0)) / 100
      ...
      >
          ...
          <Box flex="1">
              ...
              <Box
                ...
                width={`${
                  effectiveGoalCents > 0
                    ? Math.min(
                        (family.budget_raised / effectiveGoalCents) * 100,
                        100,
                      )
                    : 0
                }%`}
            ...
            <Flex justify="space-between" mt={1}>
              <Text fontSize="xs" color="gray.500">
                Raised: ${centsToDollars(family.budget_raised)}
              </Text>
              <Text fontSize="xs" color="gray.500">
        ...
        <Flex gap={2} mb={2}>
          <a
            ...
            href={
              family.username
                ? `https://dev.creatorshare.com/sponsorships/${family.username}`
                : undefined
            }
            target="_blank"
