...
const placeholderImage = "https://cdn-icons-png.flaticon.com/512/616/616408.png"; // animal placeholder
  ...
  useEffect(() => {
    async function fetchAnimals() {
      ...
      try {
        ...
        const url = `/api/animals/getByAgeAndGender?${queryParams.toString()}`;
        ...
        if (res.ok) {
          ...
          const animalList = data.beneficiary;
