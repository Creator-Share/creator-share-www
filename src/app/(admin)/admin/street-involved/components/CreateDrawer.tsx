...
const CreateDrawer: React.FC<CreateDrawerProps> = ({
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      toaster.create({
        title: "Error",
        description: "Failed to add street involved person",
        duration: 5000,
      });
    } finally {
      setIsAdding(false);
    ...
    >
      ...
      <DrawerTrigger asChild>
        <Button className="border-[2px] border-[#E0E0E0] w-fit h-[40px] px-4">
          <GoPlusCircle className="mr-[3.5px]" /> New Person
        </Button>
      </DrawerTrigger>
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>
            <Text fontSize="5xl">Add a Street Involved Person</Text>
          </DrawerTitle>
        </DrawerHeader>
        <DrawerBody>
          <Fieldset.Root size="lg">
            <Stack>
              ...
              <Fieldset.HelperText>
                Please provide person details below.
              </Fieldset.HelperText>
            </Stack>
            <Fieldset.Content>
