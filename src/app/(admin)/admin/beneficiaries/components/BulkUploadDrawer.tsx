...
const BulkUploadDrawer = ({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const formattedChildren = newChildren.map(
        ...
        <DrawerBody>
          <Fieldset.Root size="lg">
            <Stack>
              ...
              <Fieldset.HelperText>
                Please upload a CSV file with the following headers: name,
                gender, birth_date, biography, introduction, budget_goal,
                status, country, location_geo (format: "lat;lng"), location_str
              </Fieldset.HelperText>
            </Stack>
            <FileUploadRoot onFileChange={handleFileChange} accept={[".csv"]}>
