...
const EditDrawer: React.FC<EditDrawerProps> = ({
  ...
  type EditBeneficiary = Omit<Partial<Beneficiaries>, "budget_goal"> & {
    budget_goal: string
  }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const budgetGoalInCents = Math.round(
        Number(formDataEdit.budget_goal) * 100,
      )
        ...
        <DrawerBody>
          <Fieldset.Root size="lg">
            <Stack>
              ...
              <Fieldset.HelperText>
                Please provide child laborer details below.
              </Fieldset.HelperText>
            </Stack>
            <Fieldset.Content>
