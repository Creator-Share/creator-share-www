...
const SponsorDialog: React.FC<SponsorDialogProps> = ({
  ...
  const handleSponsor = () => {
    window.location.href = `/street-involved/checkout?id=${people.id}`;
  };
        ...
        <DialogBody>
          <VStack gap={6} align="stretch">
            ...
            <Box className="bg-gray-50 p-4 rounded-lg">
              ...
              <Text>
                By sponsoring {people.name}, you're helping provide a safe haven and support
                for a child living on the streets. Your support offers protection, guidance,
                and opportunities for a better future away from the dangers of street life.
              </Text>
            </Box>
